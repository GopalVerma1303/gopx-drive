...
const TOOLBAR_ITEMS: Record<ToolbarItemId, ToolbarItem> = {
  ...
  comments: { id: "comments", label: "Comments", icon: Percent },
  mathBlock: { id: "mathBlock", label: "Math Block", icon: SquareSigma },
  insertAlert: { id: "insertAlert", label: "Insert Alert", icon: CircleAlert },
