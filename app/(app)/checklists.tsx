...
export default function ChecklistsScreen() {
  ...
  const {
    ...
    queryFn: () => listChecklists(user?.id),
                  ...
                  {filteredChecklists.map((checklist, index) => {
                    ...
                    return (
                      ...
                      >
                        <ChecklistCard
                          checklist={checklist}
                          onPress={() => router.push(`/(app)/checklist/${checklist.id}`)}
                          onDelete={() =>
                            handleRightClickDelete(checklist.id, checklist.title)
                          }
                          onRightClickDelete={
                            Platform.OS === "web"
                              ? () =>
        ...
        deleteDialogOpen && (
          ...
          >
            ...
            >
              ...
              >
                Are you sure you want to delete "{checklistToDelete?.title}"?
...
function ChecklistCard({
  ...
  // Square card - same width and height
  ...
  return (
    ...
    >
      <Animated.View style={{ transform: [{ scale }] }}>
        <View
        className="bg-muted border border-border rounded-2xl p-4 justify-between"
