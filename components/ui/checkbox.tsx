...
function Checkbox({
  ...
  return (
    <CheckboxPrimitive.Root
      className={cn(
        'border-input dark:bg-input/30 size-4 shrink-0 rounded-[4px] border-2 shadow-sm shadow-black/5',
        Platform.select({
        ...
        props.checked && cn('border-green-500 bg-green-500', checkedClassName),
        !props.checked && 'bg-transparent border-red-500 border-2',
      ...
      <CheckboxPrimitive.Indicator
        className={cn('bg-green-500 h-full w-full items-center justify-center', indicatorClassName)}>
        <Icon
          as={Check}
          size={12}
